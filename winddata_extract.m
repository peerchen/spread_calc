function[processed_data]=winddata_extract(startdate,starttime,enddate,endtime,contract,isxx)
w=windmatlab;
...
processed_data=[date(idx) time(idx) filled_data(idx,:) sn flags(idx)];
